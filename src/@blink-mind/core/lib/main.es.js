...
var Topic = /** @class */ (function (_super) {
    ...
    Object.defineProperty(Topic.prototype, "emoji", {
        get: function () {
    ...
    Topic.fromJSON = function (obj) {
        var key = obj.key, _a = obj.parentKey, parentKey = _a === void 0 ? null : _a, blocks = obj.blocks, _b = obj.subKeys, subKeys = _b === void 0 ? [] : _b, _c = obj.collapse, collapse = _c === void 0 ? false : _c, _d = obj.emoji, emoji = _d === void 0 ? null : _d;
        return new Topic({
            key: key,
            parentKey: parentKey,
            emoji: emoji,
    ...
    Topic.create = function (_a) {
        var key = _a.key, _b = _a.parentKey, parentKey = _b === void 0 ? null : _b, _c = _a.content, content = _c === void 0 ? '' : _c, _d = _a.subKeys, subKeys = _d === void 0 ? [] : _d, _e = _a.collapse, collapse = _e === void 0 ? false : _e, _i = _a.emoji, emoji = _i === void 0 ? '' : _i;
...
function addEmoji(_a) {
    var model = _a.model, topicKey = _a.topicKey, emoji = _a.emoji, focusMode = _a.focusMode;
    var topic = model.getTopic(topicKey);
    if (topic) {
        // if (emoji !== topic.emoji) {
            model = model.updateIn(['topics', topicKey, 'emoji'], function (s) { return emoji; });
        // }
        return focusTopic({
            model: model,
            topicKey: topicKey,
